...
//github.com/rikik99/Foodrawing.git
...
public class UserController {
	...
	@GetMapping("/login")
	public ModelAndView loginProcess(HttpServletRequest request, Authentication authentication) {
	...
	public ModelAndView linkAccountProcess(HttpServletRequest request, @ModelAttribute UserSocialLinksDTO social,
	...
	@ResponseBody
	public VerificationResponseDTO verifyIdCode(@RequestBody VerificationRequestDTO request, HttpSession session,
			Model model) {
	...
	@ResponseBody
	public VerificationResponseDTO verifyPasswordCode(@RequestBody VerificationRequestDTO request, HttpSession session,
			Model model) {
		String sessionCode = (String) session.getAttribute("verificationCode");
		String email = request.getEmail();
	...
	public String getOrderHistory(@RequestParam(required = false) String startDate,
	...
	public String myPageOrderCancel(@RequestParam(required = false) String startDate,
			@RequestParam(required = false) String endDate, Model model) {
		// 로그인 가져오기
		Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
		boolean isLoggedIn = authentication != null && authentication.isAuthenticated()
