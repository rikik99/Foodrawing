    ...
    <div class="login-container">
        ...
        <form action="<c:url value='/login' />" method="post">
            ...
            <div class="login-input">
                ...
                <input type="text" id="username" name="username" placeholder="아이디 6-20자" required>
            </div>
            <div class="login-input">
                <label for="password">비밀번호</label>
                <input type="password" id="password" name="password" placeholder="비밀번호 영문, 특수문자, 숫자조합 8-12자" required>
            </div>
            ...
            <div class="login-options">
                ...
                <div>
                    <a href="<c:url value='/findUsername' />">아이디 찾기</a> |
        ...
        <div class="login-social">
            ...
            <a href="<c:url value='/oauth2/authorization/naver' />" class="social-btn naver">
                <img src="<c:url value='/images/btnG_완성형.png' />" alt="네이버 로그인">
            </a>
        </div>
        <div class="login-footer">
            <a href="<c:url value='/signupInfo' />" class="signup-btn">회원가입</a>
            <a href="<c:url value='/guest/findOrder' />" class="guest-order">비회원 주문배송 조회</a>
