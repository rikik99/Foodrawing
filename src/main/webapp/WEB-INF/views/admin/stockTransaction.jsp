...
<link rel="stylesheet" type="text/css"
	href="<c:url value='/css/admin/adminTransaction.css'/>">
</head>
		...
		<div class="main-content dark-mode" id="mainContent">
			...
			<table class="product-list dark-mode">
				<thead>
					<tr>
						<th>이미지</th>
						<th class="sortable" data-column="product" data-type="string">상품명(상품
							코드, 상품명)<span class="sort-icon asc">▲</span><span
							class="sort-icon desc">▼</span>
						</th>
						<th class="sortable" data-column="type" data-type="string">입/출고<span
							class="sort-icon asc">▲</span><span class="sort-icon desc">▼</span></th>
						<th class="sortable" data-column="quantity" data-type="number">수량<span
							class="sort-icon asc">▲</span><span class="sort-icon desc">▼</span></th>
						<th class="sortable" data-column="date" data-type="date">입출고
							날짜<span class="sort-icon asc">▲</span><span
							class="sort-icon desc">▼</span>
						</th>
						<th class="sortable" data-column="expiration" data-type="date">유통
							기한<span class="sort-icon asc">▲</span><span
							class="sort-icon desc">▼</span>
						</th>
					</tr>
				</thead>
				<tbody id="stockTableBody">
					<tr>
						<td><img src="http://example.com/image1.jpg" alt="상품1 이미지"
					...
					<tr>
						<td><img src="http://example.com/image2.jpg" alt="상품2 이미지"
							width="50" height="50"></td>
