                ...
                <div class="search-bar">
                    ...
                    <div class="full-width">
                        <div class="half-width">
                            ...
                            <div id="radio-group">
                                <label><input type="radio" name="resolved_status" value="" checked> 전체</label>
                                <label><input type="radio" name="resolved_status" value="N"> 답변 대기 중</label>
                                <label><input type="radio" name="resolved_status" value="Y"> 답변 완료</label>
                            </div>
                        </div>
                    </div>
