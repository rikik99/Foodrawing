...
<body class="dark-mode">
	<div class="updateProduct-form-container">
		<form id="updateProductForm" method="post"
			action="/admin/updateProduct/${product.productNumber}" enctype="multipart/form-data"
			...
			<table class="form-table">
				<tr>
					...
					<td><input type="text" id="productNumber" name="productNumber"
						...
						value="${product.productNumber}"></td>
				</tr>
				<tr>
					...
					<td><select id="category" name="category" class="secondary">
							...
							<c:forEach items="${categoryList}" var="category">
								<option value="${category.id}"
									${category.id == product.productCategoryDTO.id ? 'selected="selected"' : ''}>${category.name}</option>
							</c:forEach>
					</select></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><img alt="사진 미리보기"
						src="${product.productFileDTO.filePath}" class="previewArea"
