			...
			<div class="container-fluid">
	            ...
	            <div class="collapse navbar-collapse nav-menu justify-content-center" id="navbarsExample08">
	                ...
	                <ul class="navbar-nav menuitems justify-content-center">
	                    ...
	                    <li class="nav-item"><a class="nav-link" href="/discounts/discountpage">할인</a></li>
	                </ul>
	            </div>
	            <div>
	                <ul class="navbar-nav nav-util justify-content-right">
	                    <c:choose>
	                        <c:when test="${isLoggedIn}">
	                            <li class="nav-item loginli"><a href="<c:url value='/logout'/>" class="login">로그아웃</a></li>
	                        </c:when>
	                        <c:otherwise>
	                            <li class="nav-item loginli"><a href="<c:url value='/login'/>" class="login">로그인</a></li>
	                        </c:otherwise>
	                    </c:choose>
