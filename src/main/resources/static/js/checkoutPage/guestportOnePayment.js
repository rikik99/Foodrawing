    ...
    function pay() {    
     ...
     // 필수 입력 필드 체크
        ...
        const orderDetails = productNumbers.map((productNumber, index) => ({
         ...
         const jsonData = {
		        guestId: cookieGuestId, // GUEST ID로 변경
		        ...
		        order: {
		            identifierId: cookieGuestId, // GUEST ID로 변경
		            identifierType: "guest", // GUEST로 변경
		            	...
		            	fetch('/guest/payment/result', {
		                 ...
		                 .then(data => {
		                     ...
		                     if (data.status === 'success') {
		                         ...
		                         window.location.href = '/guest/cart';
		                     }
		                 })
		                 .catch(err => {
		                     console.error(err);
