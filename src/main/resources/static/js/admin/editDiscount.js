    ...
    document.addEventListener('click', function(e) {
        if (e.target.id === 'editDiscount') {
            ...
            rows.forEach(row => {
                const cells = row.querySelectorAll('td');
                const rowData = {};
                rowData.id = row.getAttribute('data-discountId'); // 추가된 부분
                ...
                cells.forEach((cell, index) => {
                    ...
                    switch (index) {
                        ...
                        case 4:
                            ...
                            break;
                        case 5:
                            rowData.minPrice = input ? input.value : cell.innerText;
                            break;
                        case 6:
                            rowData.maxDiscount = input ? input.value : cell.innerText;
                            break;
                        case 7:
